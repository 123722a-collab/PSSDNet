...
def init_ff(dataset='all',phase='test'):
	...
	original_path='data/FaceForensics++/original_sequences/youtube/c23/videos/'
	...
	folder_list=[]
	for fake in fakes:
		fake_path=f'data/FaceForensics++/manipulated_sequences/{fake}/c23/videos/'
...
def init_dfd():
	real_path='data/FaceForensics++/original_sequences/actors/c23/videos/*.mp4'
	real_videos=sorted(glob(real_path))
	fake_path='data/FaceForensics++/manipulated_sequences/DeepFakeDetection/c23/videos/*.mp4'
